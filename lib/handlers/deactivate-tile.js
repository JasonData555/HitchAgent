 ...
 *
 * Deactivates a Candidate Tile. Called by an Airtable automation when a
 * Program Manager checks the "Deactivate Tile" checkbox on a Tiles record.
 *
 ...
 * ─────────────────────────────────────────────────────────────────────────────
 * Deactivation is now enforced by the "Tile Status" field on the Candidate
 * Tile record. The /api/tile-view rendering endpoint checks this field on
 * every request and returns the unavailable page when it equals "Deactivated".
 *
 ...
 * "Tile Status" to "Deactivated" directly. This endpoint is retained for
 * backward compatibility.
 *
 * ─────────────────────────────────────────────────────────────────────────────
 * REACTIVATION
 * ─────────────────────────────────────────────────────────────────────────────
 * Reactivation requires no API call — simply change "Tile Status" back to
 * "Active" in Airtable. The rendering endpoint will immediately serve content
...
export default async function handler(req, res) {
  ...
  log('request_received', { endpoint: 'deactivate-tile' });

  // Deactivation is now enforced by the Tile Status field check in /api/tile-view.
