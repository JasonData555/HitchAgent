...
export async function createCandidateTilePresentation(data) {
  ...
  // ── ROW 1: Relevant Domain Expertise (full width) ───────────────────────────
  ...
  // ── DIVIDER: Between RDE row and Reasons row ─────────────────────────────────
  slide.addShape(pptx.ShapeType.rect, {
    x: RIGHT_X,
    y: 4.03,
    w: RIGHT_W,
  ...
  // ── ROW 2: Reasons to Consider (full width) ──────────────────────────────────
  ...
  // ── DIVIDER: Between Reasons row and bottom row ───────────────────────────────
  slide.addShape(pptx.ShapeType.rect, {
    x: RIGHT_X,
    y: 5.43,
    w: RIGHT_W,
  ...
  // ── DIVIDER: Vertical divider splitting bottom row ────────────────────────────
  slide.addShape(pptx.ShapeType.rect, {
    x: 8.43,
    y: 5.43,
    w: 0.015,
  ...
  // ── ROW 3 LEFT: Culture Add ───────────────────────────────────────────────────
  slide.addText('CULTURE ADD', {
    x: RIGHT_X,
    y: 5.50,
    w: 4.45,
    h: 0.22,
  ...
  slide.addText(stripMarkdown(cultureAdd) || '', {
    x: RIGHT_X,
    y: 5.74,
    w: 4.45,
    h: 1.23,
  ...
  // ── ROW 3 RIGHT: Anticipated Concerns ────────────────────────────────────────
