...
const HTML_CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .preview-dot { width: 5px; height: 5px; border-radius: 50%; flex-shrink: 0; margin-top: 6px; }

  .preview-text { font-size: 12px; color: #374151; font-style: italic; line-height: 1.5; }
...
export function buildRubricHtml({
  ...
  const sections = [
    { key: 'fr',  label: 'Functional Responsibility', accentColor: '#0F2D52', content: functionalResponsibility, isDefaultOpen: false, hasPreview: true },
    { key: 'sr',  label: 'Success in Role',            accentColor: '#0F2D52', content: successInRole,           isDefaultOpen: false, hasPreview: true },
    { key: 'mh',  label: 'Must Have',                  accentColor: '#166534', content: mustHave,                isDefaultOpen: false, hasPreview: true },
