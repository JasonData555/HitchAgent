...
export function createRubricHtml({
   ...
   */
  function buildSection({ title, accentClass, content, expanded, skipIfEmpty, emptyMsg, dataCol }) {
    ...
    const chevron = `<svg class="chevron" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 5L7 9L11 5" stroke="#9CA3AF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`;

    return `<div class="rubric-section ${accentClass}${expandedClass}"${dataColAttr}>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @media print {
      ...
      .section-body { padding: 14px 0 18px !important; }
      .rubric-section.expanded .section-header-row,
