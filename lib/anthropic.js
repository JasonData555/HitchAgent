 ...
 * synthesizeCandidateContent() → { situation, relevantDomainExpertise, cultureAdd, anticipatedConcerns }
 */
...
async function callClaude(prompt) {
  ...
  const REQUIRED = ['situation', 'relevantDomainExpertise', 'cultureAdd', 'anticipatedConcerns'];
 ...
 * @returns {Promise<{ situation: string, relevantDomainExpertise: string, cultureAdd: string, anticipatedConcerns: string }>}
 */
