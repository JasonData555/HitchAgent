...
Include 2-3 roles maximum. Focus on roles most relevant to the ${sanitizeField(roleTitle)} position.

3. REASONS TO CONSIDER (3-5 bullets)
Key selling points for why the client should interview this candidate. Each bullet should highlight a specific, compelling qualification:
- Lead with impact: what makes this person stand out
- Include quantifiable achievements where available
- Reference experience directly relevant to the ${sanitizeField(roleTitle)} role
- Highlight leadership caliber, strategic thinking, or unique expertise
