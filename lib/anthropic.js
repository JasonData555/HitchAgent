...
Write a 2-3 sentence executive summary for the client that:
1. Highlights areas of strong alignment (where panel agrees on importance)
2. Diplomatically flags areas needing discussion (conflicts)
3. Frames conflicts constructively — as opportunities to clarify priorities, not as problems

CRITICAL RULES:
- Do not use names of panel members — refer to them by role (e.g., "the CEO", "the CTO")
- Do not be alarmist about conflicts — they are normal and expected
