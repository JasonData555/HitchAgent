...
const CSS = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Manual blank-line spacer: a blank line in the raw field text adds extra
     space before the next block. Margins collapse with any margin-top already
     on that element (.block-heading, .company-header), so this composes safely
     — the browser simply takes the larger of the two. */
