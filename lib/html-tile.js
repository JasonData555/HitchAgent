...
/**
 * Render Anticipated Concerns: semicolons become line breaks.
 */
...
const CSS = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media print {
    ...
    /* Pull Situation section up 10px */
    .sidebar .situation {
      margin-top: -10px;
    }

    /* Pull Contact Info section up 20px */
    .sidebar .contact {
      margin-top: -20px;
    }
...
export async function createCandidateTileHtml({
  ...
  const linkedinHtml = linkedinUrl
    ? `<a class="linkedin-link" href="${escapeHtml(linkedinUrl)}">LinkedIn Bio</a>`
    : '';
  ...
  const educationSection = education
    ? `<div class="section education">
        ...
        <div class="section-body"><p>${escapeHtml(education)}</p></div>
      </div>`
    : '';
